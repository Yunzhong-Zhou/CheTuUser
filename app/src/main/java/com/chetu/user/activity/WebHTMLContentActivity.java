...
public class WebHTMLContentActivity extends BaseActivity {
    String article_id = "";
    WebView webView;
    ...
    protected void initView() {
        ...
        webView.getSettings().setDatabasePath(WebHTMLContentActivity.this.getApplicationContext().getCacheDir().getAbsolutePath());
...
//        webView.loadUrl(url);//加载web资源
    ...
    private void take() {
        ...
        WebHTMLContentActivity.this.startActivityForResult(chooserIntent, FILECHOOSER_RESULTCODE);
    }
