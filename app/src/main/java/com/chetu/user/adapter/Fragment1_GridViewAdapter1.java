 ...
 */
public class Fragment1_GridViewAdapter1 extends BaseAdapter {
    private Context context;
    private List<Fragment1Model.ListBean> list;
    private int selectIndex = 0;

    public Fragment1_GridViewAdapter1(Context context, List<Fragment1Model.ListBean> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_fragment1_gridview1, null);
